...
tiles = function(){ /*Insert your own tiles here*/
	...
	tileSlideshow(2,0,0,2,2,"","",5000,true,"fadeslide",["img/bg/p2.jpg","img/bg/b3.png","img/bg/p1.jpg"],['Slideshow','#789600','top'],'noClick');
	tileSlideshow(2,0,2,1,1,"","",2500,false,"fliphorizontal",["img/bg/p1.jpg","img/bg/p2.jpg","img/bg/b3.png"],['','',''],'noClick');
	
	tileCustom(2,1,2,1,1,"#BBB","#&home","<img src='img/arrows/arrowLeftBak.png' style='margin-top:42px;margin-left:52px;padding-bottom:15px;' height='41'><h4 class='align-center'>Go home</h4>",['','',''],'');
}
